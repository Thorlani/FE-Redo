  ...
  return (
    <>
      <div className='px-[8%]  w-full '>
        ...
        <p className='mb-4'>Traffic Monitoring helps us identifying the exact number of traffic on our site. Monitoring traffic, we use Google Analytics tool. Google Analytics helps us to collect visitors data and analyze traffic on our site. All these activities are conducted in order to improve the user experience. Google doesn’t sell such information to any third parties for data mining or marketing purpose. You can check Google privacy policy visiting this link <a className='text-[#60d3c9]' href="https://policies.google.com/privacy">https://www.google.com/policies/privacy/</a></p>
        ...
        <p className='mb-4'><a className='text-[#60d3c9]' href="https://www.google.com/policies/privacy/">https://www.google.com/policies/privacy/</a></p>
        ...
        <p className='mb-4'><a className='text-[#60d3c9]' href="https://www.facebook.com/policy.php">https://www.facebook.com/policy.php</a></p>
        <p className='mb-4'><a className='text-[#60d3c9]' href="https://help.instagram.com/155833707900388">https://help.instagram.com/155833707900388</a></p>
        <p className='mb-4'><a className='text-[#60d3c9]' href="https://twitter.com/en/privacy">https://twitter.com/en/privacy</a></p>
